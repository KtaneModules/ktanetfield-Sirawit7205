...
#pragma warning disable 414
    private readonly string TwitchHelpMessage = @"Press the button at column 2 row 3 and column 1 row 4 with “!{0} press 2,3 1,4” (Separate multiple buttons with spaces).";
