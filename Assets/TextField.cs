...
#pragma warning disable 414
    private readonly string TwitchHelpMessage = @"Press the button at column 2 row 3 and column 4 row 1 with “!{0} press 2,3 4,1” (Separate multiple buttons with spaces).";
